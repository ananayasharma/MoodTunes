...
background-image: url("https://images.unsplash.com/photo-1617957718645-7680362d6312?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D");
...
st.markdown('<h1 style="font-size: 32px; color: white;"> MoodTunes-Spotify 💚</h1>', unsafe_allow_html=True)
...
if "run" not in st.session_state:
    st.markdown('<h6 style="font-size: 20px; color: white;"> Looks like you have skipped the face scan on the homepage and came here, just for music, just choose your vibe manually for Vibescape to groove with you!</h6>', unsafe_allow_html=True)
    ...
    st.write(f'<span style="color:black">Your current emotion is: {st.session_state["emotion"]}</span>', unsafe_allow_html=True)
