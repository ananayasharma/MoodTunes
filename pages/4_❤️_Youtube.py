...
background-image: url("https://img.freepik.com/free-photo/red-background-with-dark-red-background_1340-36355.jpg?t=st=1713092513~exp=1713096113~hmac=2e2450988a7bade8d89f92328601065eed7ea6a9318a5f42bab91b959aea0791&w=1060");
...
"""
# add_logo("https://img.icons8.com/?size=80&id=sRwG9M4ntQFF&format=png")

st.markdown(page_bg_img, unsafe_allow_html=True)
# st.title("❤️ Vibescape-Youtube")
st.markdown('<h1 style="font-size: 32px; color: white;"> MoodTunes-Youtube ❤️ </h1>', unsafe_allow_html=True)
st.markdown(''':white[**Note : It is recommended that you scan your face , for Vibescape to groove with you!**]''')
