...
background-image: url("https://images.unsplash.com/photo-1557682260-96773eb01377?q=80&w=2029&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D");
...
st.markdown('<h1 style="font-size: 32px; color: black;"> MoodTunes-SounCloud 🧡</h1>', unsafe_allow_html=True)
# st.markdown('<h1 style="font-size: 32px; color: blue;">🧡 Vibescape-Soundcloud</h1>', unsafe_allow_html=True)
